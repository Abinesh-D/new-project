...
//           const tokenObj = { accessToken: token, username: userName } 
//           const validUserObj = { ...validUser[0], ...tokenObj, ...user.name }
...
//           const tokenObj = { accessToken: token, username: userName } 
//           const validUserObj = { ...user[0], ...tokenObj, ...user.name } 
...
//           resolve([200, modifiedComments])swiper/react
//         } else {
//           reject([400, "Cannot add comment"])
//         }
//       })
