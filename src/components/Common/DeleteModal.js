...
const DeleteModal = ({ show, onDeleteClick, onCloseClick, mode, handleSubmit, topicError, topicMsg, topicName, setTopicName, profileName, warningText }) => {
        ...
        <ModalBody className="px-4 py-5 text-center">
          ...
          {mode === undefined ? (
            <>
              ...
              <p className="text-muted font-size-16 mb-4">{warningText} <span className="font-weight-bold"><strong>{profileName}</strong></span> permanently.</p>
              <div className="hstack gap-2 justify-content-center mb-0">
                <button type="button" className="btn btn-danger" onClick={onDeleteClick}>OK</button>
