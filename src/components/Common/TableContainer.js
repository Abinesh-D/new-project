    ...
    <Fragment>
      <Row className="mb-2">
        ...
        {showCheckBox &&
          <Col >
            <div className="text-sm-end">
              <Button type="button" color="success" className="btn mb-2 me-2 btn-sm" onClick={handlePublishCourse} >
                <i className="mdi mdi-plus-circle-outline me-1" /> Publish Course
              </Button>
            </div>
          </Col>
        }
