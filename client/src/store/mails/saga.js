...
function* mailsSaga() {
  yield [
    takeEvery(GET_MAILS_LIST, fetchMailsLists),
    takeEvery(SELECT_FOLDER, onSelectFolders),
    takeEvery(GET_SELECTED_MAILS, onGetSelectedMails),
    takeEvery(SET_FOLDER_SELECTED_MAILS, onSetFolderOnSelectedMails),
    takeEvery(UPDATE_MAIL, onUpdateMail)
  ];
}
